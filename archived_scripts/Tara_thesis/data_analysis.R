...
no_observations1 <- dplyr::select(no_observations, -X0.2mm, -X2.5mm, -X5.10mm, -X10.20mm, -X.20mm)
...
topdown6 <- dplyr::select(topdown5, StateRouteStop_Station, Date)
...
all_abundance1_12<- dplyr::select(all_abundance_12, -Freq,-TrapType.y, -StateRouteStop.y, -Station.y, -VisitNumber.y, -surveyID)
...
food_abundance1_12<- dplyr::select(food_abundance_12, -Freq,-TrapType.y, -StateRouteStop.y, -Station.y, -VisitNumber.y, -surveyID)
...
caterpillar_abundance1_12<- dplyr::select(caterpillar_abundance_12, -Freq,-TrapType.y, -StateRouteStop.y, -Station.y, -VisitNumber.y, -surveyID)
...
paired_all2 <- dplyr::select(paired_all1, -Visit3, -visit_dif, -ID)
...
paired_all3 <- dplyr::select(paired_all1, -Visit1, -visit_dif, -ID)
...
paired_all5 <- dplyr::select(paired_all4, -StateRouteStop.y, -Station.y, -ID)
...
paired_food2 <- dplyr::select(paired_food1, -Visit3, -visit_dif, -ID)
...
paired_food3 <- dplyr::select(paired_food1, -Visit1, -visit_dif, -ID)
...
paired_food5 <- dplyr::select(paired_food4, -StateRouteStop.y, -Station.y, -ID)
...
paired_caterpillar2 <- dplyr::select(paired_caterpillar1, -Visit3, -visit_dif, -ID)
...
paired_caterpillar3 <- dplyr::select(paired_caterpillar1, -Visit1, -visit_dif, -ID)
...
paired_caterpillar5 <- dplyr::select(paired_caterpillar4, -StateRouteStop.y, -Station.y, -ID)
...
all_time1_12 <- dplyr::select(all_time_12, -Visit3, -visit_dif)
...
all_time2_12 <- dplyr::select(all_time_12, -Visit1, -visit_dif)
...
all_time4_12 <- dplyr::select(all_time3_12, -StateRouteStop.y, -Station.y, -ID)
...
food_time1_12 <- dplyr::select(food_time_12, -Visit3, -visit_dif)
...
food_time2_12 <- dplyr::select(food_time_12, -Visit1, -visit_dif)
...
food_time4_12 <- dplyr::select(food_time3_12, -StateRouteStop.y, -Station.y, -ID)
...
caterpillar_time1_12 <- dplyr::select(caterpillar_time_12, -Visit3, -visit_dif)
...
caterpillar_time2_12 <- dplyr::select(caterpillar_time_12, -Visit1, -visit_dif)
...
caterpillar_time4_12 <- dplyr::select(caterpillar_time3_12, -StateRouteStop.y, -Station.y, -ID)
...
ex_station=filter(topdown10, StateRouteStop =="8890236" & Station== "3B") #to find dates of these surveys/Julian days
#Jday 151 and Jday 179
example = all_abundance2_12
example$jday = ifelse (example$VisitNumber == 3, 179,
                ifelse (example$VisitNumber ==1, 151, NA))

ex_graph_data <-dplyr::filter(example, StateRouteStop == "8890236", Station== "3B")
ex_graph_data$VisitNumber <- as.numeric(as.character(ex_graph_data$VisitNumber))
plot(ex_graph_data$jday, ex_graph_data$VFX, xlim=range(c(150,180)), ylim=c(1,5), 
            xlab="Julian day", ylab="Arthropod Density", type="b", col="red")
points(x=ex_graph_data$jday, y=ex_graph_data$VF, type="b", col="blue")
